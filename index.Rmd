...
# **Sesión Cero: Introducción a la investigación abierta reproducibles**
...
# **Sesiones de R con Google Earth Engine (GEE)**

(11 y 12 de Agosto, UCSC Concepción presencial)

[carlos.lara\@ucsc.cl](mailto:carlos.lara@ucsc.cl){.email}
...
-   **Target group**: estudiantes, investigadores y público en general que desee realizar análisis en percepción remota usando Google Earth Engine desde R.
...
# **Sesiones de investigacion multidisciplinaria reproducible en Arqueología, Paleoecología, Paleoclimatología y Ecología**

(11 y 12 de Agosto. Presencial PUC San Joaquín Santiago)
