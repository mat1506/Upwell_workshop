...
[![Figura 4. Instalar R en Windows](images/%C3%ADndice3.png)](https://cran.r-project.org/)
...
La función de recuperación de paquetes previamente instalada está
disponible actualmente solo si se inicia udpater desde base R en lugar
de IDE como Rstudio. La función de recuperación de paquetes previamente
instalada está en modo beta y es posible que deba volver a instalar
manualmente sus paquetes después de actualizar la versión R. Gracias a
Dios son gratis :)
...
Para actualizar R, simplemente ejecute updateR (). Se le 
pedirá que ingrese la contraseña de administrador en el proceso. La 
función mostrará la versión a la que se actualizó R cuando finalice.
...
## 4. Entorno de trabajo de RStudio
...
Vamos a instalar algunos paquetes de R para tener una version mínima de Latex que nos permitirá trabajar con R Markdown y hacer documentos dinamicos e introducirnos a la programación en Latex, para esto instale los siguientes paquetes:
